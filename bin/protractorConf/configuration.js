...
exports.config = {
 ...
 //// chromeDriver: './selenium/chromedriver',
  ...
  capabilities: {
    ...
    specs: ['example/chromeOnlySpec.js'],
  ...
  splitTestsBeweenCapabilities:true,
  multiCapabilities: [
   {'browserName': 'chrome',
   name:'TabName-1',
  shardTestFiles:false,
  specs:['../src/test/loginTest.js'],
  maxInstances:1
  ...
  browser.user=browser.params.user;
  browser.language=browser.params.lanaguage;
